...
if (isset($db)){
    if ($obj->username == "theo"){
        ...
        $stmt = $db->prepare("SELECT username, exam_id, earned_points, updated_points, possible_points, grade, comments from Grades WHERE username = :username and released = 1;");
